...
exports.updateTransaksi = async (request, response) => {
    try {
        ...
        let arrDetail = request.body.detail_transaksi
        for (let i = 0; i < arrDetail.length; i++) {
            arrDetail[i].id_transaksi = id_transaksi // proses menyisipka latestID di setiap array
            ...
            /** add harga in each of detail */
            arrDetail[i].harga = selectedMenu?.harga
            // ? : antisipasi bila tidak menemukan menu berdasar id 
        }
    ...
    try {
        ...
        let result = await transaksiModel
            .findAll({
                ...
                order:[
                    ['tgl_transaksi', 'DESC'] // descending ; urutin dari data terbaru
                ]
            })
...
/** create and export function  to find transaksi- */
